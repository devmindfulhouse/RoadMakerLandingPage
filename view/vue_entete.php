...
<head>
    <script>(function(w,d,s,l,i){w[l]=w[l]||[];w[l].push({'gtm.start':
        ...
        })(window,document,'script','dataLayer','GTM-WH5QRF83');</script>

    <meta charset="UTF-8">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.5.1/css/all.min.css" integrity="sha512-DTOQO9RWCH3ppGqcWaEA1BIZOC6xxalwEsw9c2QQeAIftl+Vegovlnee1c9QX4TctnWMn13TZye+giMm8e2LwA==" crossorigin="anonymous" referrerpolicy="no-referrer" />
    <link type="text/css" rel="stylesheet" href="assets/css/main.css">
    <link type="text/css" rel="stylesheet" href="assets/css/offers_details.css">
    <link rel="icon" href="assets/imgs/logo_connexion.ico" class="icon" type="image/x-icon">
    ...
    <nav class="navbar--container navbar navbar-expand-lg navbar-dark fixed-top">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav ms-sm-3 ms-lg-auto">
                    ...
                    <li class="nav-item">
                        <a class="nav-link text-white" aria-current="page" href="index.php#news">Actualités</a>
                    </li>
                    <li class="nav-item">
                    ...
                    <li class="nav-item">
                        <a class="nav-link text-white" href="index.php?section=who_we_are">Qui sommes-nous ?</a>
                    </li>
