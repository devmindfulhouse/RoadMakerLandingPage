    ...
    <div class="main-content" >
        <section class="tourism_offer--container">
            ...
            <div class="videos--container d-flex flex-column flex-lg-row gap-3 align-items-center jusitfy-content-around">
                <div class="video--container--item d-flex flex-column justify-content-center align-items-center">
                    <iframe src="https://www.youtube-nocookie.com/embed/DE4B52U-OAk?si=YXSgBtOgGl6-9lUu"
                            title="YouTube video player" frameborder="0"
                            allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share"
                            referrerpolicy="strict-origin-when-cross-origin" allowfullscreen>
                    </iframe>
                    <h3 class="fw-bold fs-5 text-center mx-5 mx-lg-0">La participation de EcoMobile Loisirs dans l'émission Tongs ou baskets de TV Vendée</h3>
                </div>
                <div class="video--container--item d-flex flex-column justify-content-center align-items-center">
                    <iframe src="https://www.youtube-nocookie.com/embed/wubP6dVs58Y?si=McO7yOJ6prmwDcAX"

                            title="YouTube video player" frameborder="0"
                            allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share"
                            referrerpolicy="strict-origin-when-cross-origin" allowfullscreen>
                    </iframe>
                    <h3 class="fw-bold fs-5 text-center mx-5 mx-lg-0">Retour en image des circuits proposées par EcoMobile Loisirs en 2023</h3>
                </div>
                <div class="video--container--item d-flex flex-column justify-content-center align-items-center">
                    <iframe src="https://www.youtube-nocookie.com/embed/7NAFA3kL2fY?si=DdFxm_gT0DPUP9cu"
                            title="YouTube video player" frameborder="0"
                            allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share"
                            referrerpolicy="strict-origin-when-cross-origin" allowfullscreen>
                    </iframe>
            ...
            <div class="socials--container d-flex flex-column flex-lg-row gap-3 align-items-center my-5 my-lg-0">
                <div class="social--container--item d-flex flex-column justify-content-center align-items-center mt-3">
                    ...
                    <h4 class="fw-bold fs-5 -center mt-2">
                ...
                <div class="social--container--item d-flex flex-column justify-content-center align-items-center mt-3">
                    ...
                    <h4 class="fw-bold fs-5 text-center mt-2">
