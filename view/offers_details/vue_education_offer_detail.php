    ...
    <div class="main-content">
        <section class="education_offer--container">
            <h1 class="fw-bolder text-center my-3 mb-6 mb-md-5 fs-2">Notre offre pour l'education et la pédagogie d'apprentissage</h1>
            <div class="videos--education--container d-flex flex-column flex-lg-row gap-3 align-items-center justify-content-around my-3 my-lg-0">
                <div class="video--education--container--item d-flex flex-column justify-content-center align-items-center">
                    ...
                    <h3 class="fw-bold fs-5 text-center mx-5 mx-lg-0">Intégration à la bibliothèque universitaire du Mans grâce à RoadMaker</h3>
                </div>
            </div>
